...
export const testimonials: Testimonial[] = [
    ...
    {
        image: "/images/testimonial/couple1.jpg",
        name: "David & Emma Martinez",
        review: "As a busy professional couple, we needed experts we could trust with our Central London portfolio. Their developer background means they understand property like no other management company.",
        position: "Portfolio Owners, Chelsea"
    },
    {
    ...
    },
    {
        ...
        review: "Their managed sale service exceeded all expectations. From property optimization to final completion, everything was handled professionally. Could not recommend more highly.",
        position: "Private Investor, Kensington"
    }
]